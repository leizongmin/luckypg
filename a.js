...
// 尝试载入最新的数据
const defineNewestFile = path.resolve(process.env.HOME, '.programmer-calendar.define.json');
try {
  ...
  var defineNewest = require('./define');
}

// 自动更新
require('./auto_update')(defineNewestFile);
